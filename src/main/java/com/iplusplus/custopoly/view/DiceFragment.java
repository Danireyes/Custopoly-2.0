...
public class DiceFragment extends DialogFragment {
    ...
    public interface DiceDialogListener {
        void onFinishDiceDialog(int diceResult, boolean b);
    }
    ...
    public static DiceFragment newInstance(String title, GameController c) {
        DiceFragment fragment = new DiceFragment(c);
    ...
    private DiceFragment(GameController c) {
        super();
        this.c = c;
    }
    ...
    private boolean diceEqual() { return this.die1Value == this.die2Value;}
    ...
    private void sendResult() {
        c.onFinishDiceDialog(die1Value + die2Value, diceEqual());
        dismiss();
    }
