...
public class PreGameActivity extends Activity implements View.OnClickListener  {
    ...
    private String nameOfgame = theme.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSkinsView();
        setupListener();
        Toast.makeText(getApplicationContext(), "The game is automatically saved, you will lose your saved process if you click on 'play'",
    ...
    private void initCards(Game game, GameTheme theme) {
        Bank bank = game.getBank();
            ...
            bank.blackCardCards = CardFactory.readBlackCardCards(getResources().openRawResource(Utilities.getResId(theme.getCardsDataPath(), R.raw.class)));
            bank.envelopeCards = CardFactory.readEnvelopeCards(getResources().openRawResource(Utilities.getResId(theme.getCardsDataPath(), R.raw.class)));
    }
