...
public class BoardFactory {
    ...
    private static final String LAND_BLACKCARD = "BlackCard";
    private static final String LAND_ENVELOPE = "Envelope";
	...
	private static void addLand(Board board, ArrayList<String> landData) {
		...
		} else if (landType.equals(LAND_BLACKCARD)) {
            board.getLands().add(new BlackCard());
        } else if (landType.equals(LAND_ENVELOPE)) {
            board.getLands().add(new Envelope());
