...
public class Bank implements Serializable {
    ...
    public ArrayList<Card> blackCardCards = new ArrayList<>();
    public ArrayList<Card> envelopeCards = new ArrayList<>();
    ...
    public ArrayList<Card> getBlackCardCards() {
        return blackCardCards;
    }

    public ArrayList<Card> getEnvelopeCards() {
