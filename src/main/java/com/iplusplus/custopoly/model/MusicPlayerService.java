...
import com.iplusplus.custopoly.view.MusicActivity;
...
public class MusicPlayerService extends Service implements OnCompletionListener,
    ...
    private static final String URL_STRING = "http://licensing.glowingpigs.com/Audio/";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        registerReceiver(broadcastReceiver, new IntentFilter(
                MusicActivity.BROADCAST_SEEKBAR));
    ...
    private void initNotification() {
        ...
        CharSequence tickerText = "Custopoly's music playing...";
